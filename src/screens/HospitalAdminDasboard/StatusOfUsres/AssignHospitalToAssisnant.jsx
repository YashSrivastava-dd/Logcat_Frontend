            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  <td
                    scope="col"
                    className="px-6 py-3 text-center text-white text-4xl font-semibold"
                  ...
                  registerUsers.map((item, index) => {
                    return (
                      <tr className="bg-white border-b hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-center ">{item.State}</td>
                        <td className="px-6 py-4 text-center ">
                          {item.Hospital_Address}
                        </td>
                        <td className="px-6 py-4 text-center ">{item.Pincode}</td>
                        <td
                          className="px-6 py-4 text-center flex"
