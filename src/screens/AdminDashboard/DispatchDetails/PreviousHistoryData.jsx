                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <h1 className="text-2xl font-extrabold">Previous History<small className="ml-2 font-semibold text-gray-500 dark:text-gray-400">Data</small></h1>
                        ...
                        <div className="w-full relative overflow-x-auto shadow-md sm:rounded-lg" style={{ borderRadius: '1.5rem' }}>
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        <th scope="col" className="px-6 py-3 text-center text-white text-base font-semibold" style={{ backgroundColor: 'rgb(152, 0, 76)' }}>
                                            Device ID
                                        </th>
                                        <th scope="col" className="px-6 py-3 text-center text-white text-base font-semibold" style={{ backgroundColor: 'rgb(152, 0, 76)' }}>
                                            Serial Number
